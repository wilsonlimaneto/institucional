...
const EbookDownloadForm = () => {
  ...
  const { register, handleSubmit, formState: { errors }, reset } = useForm<EbookFormData>({
    ...
    defaultValues: { // Set default values to ensure form is controlled
    ...
    <section id="ebook" className="py-16 md:py-24 lg:py-32">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 md:order-2 relative aspect-[4/3] rounded-xl overflow-hidden shadow-2xl">
            <Image
