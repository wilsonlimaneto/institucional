...
const diferenciais = [
  ...
  { text: 'Facilidade e intuitividade no uso (sem precisar de prompts milagrosos)' },
  { text: 'Pesquisa jurisprudencial verificada e mais assertiva por usar tecnologia Semântica®' },
